myApp.controller('dashboardController', function ($scope, $location,$routeParams,$cookies,questionFactory){
	...
	//SHOW QUESTIONS- this section will be the main part of the page
